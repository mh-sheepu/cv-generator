...
app.post('/generate-cv', async (req, res) => {
  ...
  try {
    ...
    // Generate CV (old endpoint)
    router.post('/generate-cv', async (req, res) => {
      // ... (keep usage of genAI if needed, but this endpoint seems unused/older)
      // For safety with new model, ensuring this doesn't break if called
